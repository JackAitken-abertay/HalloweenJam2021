...
public class Enemy : MonoBehaviour
{
    ...
    public void PassedTrigger()
    {
        ...
        Debug.Log(EnemiesCSectionIndex);
    ...
    void Update()
    {
        ...
        Debug.Log("PlayerDist: " + distanceToPlayer);
        ...
        Collider[] HitObjs = Physics.OverlapBox(this.transform.position, new Vector3(ChunkSize, 50.0f, 0.5f), this.transform.rotation);
